...
wget -O Emby.Web.dll -P /opt/emby-server/system/ https://act.jiawei.xin:10086/tmp/?dir=emby/4.7.5.0/linux64_docker_4.7.5/Emby.Web.dll
rm -f /opt/emby-server/system/MediaBrowser.Model.dll
wget -O MediaBrowser.Model.dll -P /opt/emby-server/system/ https://act.jiawei.xin:10086/tmp/?dir=emby/4.7.5.0/linux64_docker_4.7.5/MediaBrowser.Model.dll
echo "核心破解完成..."
rm -f /opt/emby-server/system/dashboard-ui/modules/emby-apiclient/connectionmanager.js
wget -O connectionmanager.js -P /opt/emby-server/system/dashboard-ui/modules/emby-apiclient/ https://act.jiawei.xin:10086/tmp/?dir=emby/4.7.5.0/linux64_docker_4.7.5/dashboard-ui/modules/emby-apiclient/connectionmanager.js
rm -f /opt/emby-server/system/dashboard-ui/embypremiere/embypremiere.js
wget -O embypremiere.js -P /opt/emby-server/system/dashboard-ui/embypremiere/ https://act.jiawei.xin:10086/tmp/?dir=emby/4.7.5.0/linux64_docker_4.7.5/dashboard-ui/embypremiere/embypremiere.js
echo "web破解完成..."
rm -f /opt/emby-server/system/Emby.Server.Implementations.dll
wget -O Emby.Server.Implementations.dll -P /opt/emby-server/system/ https://act.jiawei.xin:10086/tmp/?dir=emby/4.7.5.0/linux64_docker_4.7.5/Emby.Server.Implementations.dll
